        ...
        <div class="box-header with-border">
		 ...
		 <div class="box-header with-border">
           ...
           <div class="box-tools pull-right">
				...
				<div>
					 <a href="<?php echo site_url();?>/searchhistory/downloadidreportind">
			...
			<div class="pull-left">
					<form action="<?php echo site_url()."/client/reportperuser";?>" method="post" id="form-search-procs">
						<div>
							 <button type="submit" class="btn btn-primary" id="btn-proc-back">
								<li class="fa fa-step-backward">&nbsp;&nbsp;back&nbsp;&nbsp;</li>
							</button>
						</div>
						<input type="hidden" name="reportnumber" id="reportnumber" value="<?php echo $this->input->post('reportnumber');?>" />
						<input type="hidden" name="sdate" id="sdate" value="<?php echo $this->input->post('sdate');?>" />
						<input type="hidden" name="edate" id="edate" value="<?php echo $this->input->post('edate');?>" />
						<input type="hidden" name="cid" id="cid" value="<?php echo $this->input->post('cid');?>" />
						<input type="hidden" name="user" id="user" value="<?php echo $this->input->post('user');?>" />
        ...
        <div class="box-body no-padding">
              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
					 ...
					 <?php if($MaritalStatus == "MARRIED"){?>
						<table class="table table-striped">	
						 ...
						 <tr>
							<td>Marriage Date</td>
							<td><?php echo (is_object($myData->HAMarriageDate)?"":$myData->HAMarriageDate);?></td>
						 </tr>						 
						 <tr>
							<td>Spouse Name</td>
						 ...
						 <tr>
							...
							<td><?php echo $SpouseSurname;?></td>
						 </tr>		
						<tr>
							<td>Spouse ID No</td>
							<td><?php echo $SpouseIDNo;?></td>
						 </tr>
						</table>	
					 <?php } else { ?>
                ...
                <div class="panel-body">
						 ...
						 <tr>
							<td>Estimate</td>
							<td><?php echo $report->ConsumerScoring->FinalScore;?></td>
						 </tr>						 
						 <tr>
							<td>Bracket</td>
							<td><?php echo $report->ConsumerAffordability->PredictedIncome;?></td>
						 </tr>						 
						 <tr>
							<td>Confidence</td>
							<td><?php echo $report->ConsumerScoring->classification;?></td>
						 </tr>						 
						 <tr>
							<td>Category</td>
							<td><?php echo $report->ConsumerScoring->RiskCategory;?></td>
						 </tr>		
						<tr>
							<td>Exception</td>
							<td><?php echo (is_array($report->ConsumerScoring->Exception_Code)?"":$report->ConsumerScoring->Exception_Code);?></td>
						 </tr>
						</table>        
