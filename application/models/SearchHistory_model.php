<?php
	class SearchHistory_model extends CI_Model {
        ...
        {
			$sql = "select reportname,reporttype,searchdata,created,outputdata from search_history where reportname='procurementreport' and searchdata='".addslashes($searchdata)."' and created > now() - INTERVAL 30 day";
			$query=$this->db->query($sql);
			return $query->result();
        }
