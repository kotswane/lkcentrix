              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <table class="table table-striped">	
						 <tr>
							<td>Estimate</td>
							<td><?php echo (is_array($report['ConsumerScoring']['FinalScore'])?"":$report['ConsumerScoring']['FinalScore']);?></td>
						 </tr>						 
						 <tr>
							<td>Bracket</td>
							<td><?php echo (is_array($report['ConsumerAffordability']['PredictedIncome'])?"":$report['ConsumerAffordability']['PredictedIncome']);?></td>
						 </tr>						 
						 <tr>
							<td>Confidence</td>
							<td><?php echo (is_array($report['ConsumerScoring']['classification'])?"":$report['ConsumerScoring']['classification']);?></td>
						 </tr>						 
						 <tr>
							<td>Category</td>
							<td><?php echo (is_array($report['ConsumerScoring']['RiskCategory'])?"":$report['ConsumerScoring']['RiskCategory']);?><td>
						 </tr>		
						<tr>
							<td>Exception</td>
				 ...
				 <div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="col">
							...
							if(is_array($consumerReport->ConsumerPropertyInformation)){
